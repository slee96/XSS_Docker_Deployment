...
create table full_hacked (session varchar(255), username varchar(255), password varchar(255);
create table review (username varchar(255) NOT NULL, rating int(2) not null, testimonial varchar(1024) not null, submitime datetime);
